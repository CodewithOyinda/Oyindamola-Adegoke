  ...
  return (
    ...
    <div className='flex md:ml-[100px] md:mr-[100px] ml-[20px] mr-[20px] justify-between mt-[50px]'>
        ...
        <div className='flex gap-[1rem] items-center align-middle'>
            ...
            <img src={wave} alt='wave' className='md:w-[40px] w-[20px] md:mt-[-15px] mt-[-22px]'/>
        </div>
        ...
        <div>
            <img src={oyinda} alt='oyinda' className='md:w-[428px] md:h-[428px] w-[350px] rounded-[1rem]'/>
        </div>
    </div>
    <div className='md:ml-[100px] md:mr-[100px] ml-[20px] mr-[20px] pt-[50px]'>
        <p className='md:text-[25px] pb-[30px] text-[18px]'>Past</p>
...
It was during my time at university that I also discovered my talent for makeup artistry, and I realized my deep passion for enhancing the beauty of things.</p>
    ...
    <div className='md:ml-[100px] md:mr-[100px] ml-[20px] mr-[20px] pt-[50px]'>
        <p className='md:text-[25px] pb-[30px] text-[18px]'>Present</p>
    ...
    <img src={present} alt='present' className='md:ml-[100px] md:mr-[100px] ml-[20px] mr-[20px]'/>
    </div>
    <div className='md:ml-[100px] md:mr-[100px] ml-[20px] mr-[20px] pt-[50px]'>
        <p className='md:text-[25px] pb-[30px] text-[18px]'>Future</p>
