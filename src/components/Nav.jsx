...
const Nav = () => {
    ...
    return (
        <div className="w-full">
                   <div className="flex justify-center md:justify-start items-center border-b-2 md:text-[22px] text-[10px] font-[600] md:ml-[100px] ml-[20px] md:mr-[100px] mr-[20px] mt-4 md:mt-10 md:overflow-auto ">
